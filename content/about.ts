export const aboutContent = {
  ...
  values: [
    {
      title: "Results First",
      description: "We measure our success by your growth. Every decision is backed by data.",
      icon: "◈",
    },
    {
      title: "Radical Transparency",
      description: "No black boxes. You always know where your money is going and what it's achieving.",
      icon: "◻",
    },
    {
      title: "Creative Courage",
      description: "Safe is boring. We push boundaries to create work that truly stands out.",
      icon: "✦",
    },
    {
      title: "Partnership Mentality",
      description: "We're not just a vendor — we're invested in your long-term success.",
      icon: "⬡",
    },
  ],
} as const;
