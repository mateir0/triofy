...
export const contactContent = {
  ...
  fields: [
    ...
    { name: "budget", label: "Monthly Budget", type: "select", placeholder: "Select budget range", required: false, options: ["< $2,500", "$2,500 – $5,000", "$5,000 – $10,000", "$10,000 – $25,000", "$25,000+", "Custom Budget"] },
    { name: "service", label: "Service Interest", type: "select", placeholder: "What are you looking for?", required: false, options: ["Branding", "Performance Marketing", "Web Design", "Content & Creative", "Automation", "Full Service", "Custom"] },
